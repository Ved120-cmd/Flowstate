...
const Questionnaire = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Get display name from localStorage (set during signup)
      ...
      const preferences = {
        ...
        hoursType: answers.hoursType,
        taskTypes: answers.taskTypes,
        workIntensity: answers.workIntensity,
        nudgeFrequency: answers.nudgeFrequency,
        workDayGoal: answers.workDayGoal
      };
